...
@section('konten')
{{-- Gunakan x-data untuk kontrol Tab Aktivitas dan Tab Leaderboard --}}
<div class="max-w-7xl mx-auto px-6 md:px-10 pt-44 pb-20 min-h-screen" x-data="{ activeTab: 'kelas4', rankTab: 'r4' }">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div class="bg-indigo-600 p-10 rounded-[3rem] shadow-lg group hover:scale-[1.02] transition-transform duration-300">
        ...
        <div class="bg-blue-600 p-10 rounded-[3rem] shadow-lg group hover:scale-[1.02] transition-transform duration-300">
        ...
        <div class="bg-emerald-600 p-10 rounded-[3rem] shadow-lg group hover:scale-[1.02] transition-transform duration-300">
    ...
    {{-- SECTION 1: Aktivitas Terbaru (Reset Harian) --}}
    <div class="bg-white rounded-[3.5rem] shadow-sm border border-slate-100 overflow-hidden mb-20">
        <div class="p-10 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center bg-slate-50/30 gap-6">
            <div>
    ...
    {{-- SECTION 2: Leaderboard (Peringkat Terbaik) --}}
    <div class="mt-20">
